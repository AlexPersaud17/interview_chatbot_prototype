...
INTERVIEW_CLIENT_PROMPT=f"You are an HR executive that interviews an interviewee called {st.session_state['name']} with experience {st.session_state.experience} and skills {st.session_state.skills}. You should interview them for the position {st.session_state.level} {st.session_state.position} at the {st.session_state.company}."

FEEDBACK_CLIENT_PROMPT='''
...
def set_default_session_state():
    ...
    if not st.session_state.messages:
        st.session_state.messages = [{
            "role": "system",
            "content": INTERVIEW_CLIENT_PROMPT
        }]
...
def display_feedback():           
    ...
    if st.session_state.feedback_shown:
        ...
        feedback_completion = feedback_client.chat.completions.create(
            ...
            messages=[
                {"role":"system",
                "content": FEEDBACK_CLIENT_PROMPT},
                {"role": "user",
